# -*- coding: utf-8 -*-
"""
Created on Mon Sep  6 17:09:53 2021

encoder's outputs 2 feature(id and action)
+
...
class distanglingGAN():
    ...
    def __encoder(self, ):
        ...
        c1 = Conv1D(64,kernel_size=5,padding='same',activation="relu")(c0)
        c1 = MaxPooling1D(pool_size=2)(c1)
        c1 = BatchNormalization()(c1)
        
        c2 = Conv1D(128,kernel_size=5,padding='same',activation="relu")(c1)
        c2 = MaxPooling1D(pool_size=2)(c2)
        c2 = BatchNormalization()(c2)
        
        f1 = GlobalAveragePooling1D()(c2)
        f1 = Dropout(rate=0.3)(f1)
        A1 = Dense(self.latent_dim)(f1)
        I1 = Dense(self.latent_dim)(f1)
        model = Model([input0], [A1,I1])
    ...
    def tsneshow(self, x_train, y_train, y_p_train, x_test, y_test, y_p_test):
        ...
        # feature representor
        inp = self.encoder.layers[0].input                                       
        output = self.encoder.layers[-4].output          
        ...
        feature_represnet = np.vstack((feature_train[0], feature_test[0]))
...
if __name__ == '__main__':
    ...
    GAN0 = distanglingGAN(frame = 50, dim = 100, num_actions = 5, num_class = 4)
