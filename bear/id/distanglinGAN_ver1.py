# -*- coding: utf-8 -*-
"""
Created on Thu May 20 21:54:37 2021
...
class distanglingGAN():
    def __init__(self, frame = 50, dim = 50, num_labels = 6, num_class = 4):
        ...
        self.combined.compile(loss=['categorical_crossentropy', 'mse'], loss_weights=[2, 1], 
...
if __name__ == '__main__':
    ...
    GAN = distanglingGAN()
    #GAN.train(X_train, Y_train, Y_p_train, X_test, Y_test, Y_p_test, n_batch=2000,batch_size=128)
