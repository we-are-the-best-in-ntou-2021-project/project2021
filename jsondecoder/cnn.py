...
# action_name_test = ["down","up","walk","run","raise","phone"]
# action_name = ["down_test","up_test","walk_test","run_test","raise_test","phone_test"]

a = de.JasonDecoder(dataset_name=action_name,frame=100,dirname="dataset1",shift=10)
data, labels = a.decoding()
labels = np.array(labels)

b = de.JasonDecoder(dataset_name=action_name_test,frame=100,dirname="dataset1",shift=10)
